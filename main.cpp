...
public:
    ...
    void self_assessment(void) 
    {
	double yearly_salary = (monthly_salary) * 12;
	double yearly_dividend = (weekly_net_dividend/2) * 52;
	double yearly_total_income = yearly_salary + yearly_dividend; 
	cout << " Yearly salary = " << yearly_salary << endl;
	cout << " Yearly dividend = " << yearly_dividend << endl;
	cout << " Yearly total income projected = " << yearly_total_income << endl;
    }
